...
protocol StyleDefinitionsProtocol: class {
    func tileColor(_ value: Int) -> UIColor
    func tileNumberColor(_ value: Int) -> UIColor
    func tileFont() -> UIFont
}

class StyleDefinitions: StyleDefinitionsProtocol {
